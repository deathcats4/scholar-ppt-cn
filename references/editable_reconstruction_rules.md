...
- palette, alignment, whitespace, and page rhythm;
...
Do not use a full-slide mockup image as the final slide background.
...
## Literature-report label policy

For literature reports and journal-club decks, do not use these presentation labels in the final PPTX:
- 读图要点;
- 读图结论;
- 关键认识;
- 综合判断;
...
“核心问题” and “结论” are allowed. Keep the supported content, but rewrite it as a direct academic statement without the extra label.
